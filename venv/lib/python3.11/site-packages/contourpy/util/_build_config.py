...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"/home/pi/qlab/bin/python3",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/tmp/pip-install-5k1a7q45/contourpy_e6a2d3c8162a422d915651ff21a97753/.mesonpy-4sr6mm57/lib/contourpy/util",
        source_dir=r"/tmp/pip-install-5k1a7q45/contourpy_e6a2d3c8162a422d915651ff21a97753/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --native-file=/tmp/pip-install-5k1a7q45/contourpy_e6a2d3c8162a422d915651ff21a97753/.mesonpy-4sr6mm57/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
